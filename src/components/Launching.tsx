...
const Launching = () => {
    ...
    return (
        <div className={`bg-[#141311] ${fonts.lato.className}`}>
            <div className="max-w-[1440px] w-[386px] mx-auto py-[120px] flex flex-col gap-[60px]">
                <div className="flex flex-col gap-[10px]">
                    <p className="text-white text-center font-bold text-[40px] leading-[52px]">
                        {'Get notified when we’re launching !'}
                    </p>
                    <p className="text-white text-center font-light text-[16px] leading-[18px] tracking-[1px]">
