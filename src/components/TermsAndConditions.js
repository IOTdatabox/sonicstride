    ...
    <>
      ...
      <div className="container max-w-[1440px] px-5 pt-2 mx-auto lg:px-10 xl:px-[63px]">
        <div className="block text-primaryColor">
          ...
          <h2 className="p-h2">Acknowledgment</h2>
          <p className="p-paragraph">
          ...
          <h2 className="p-h2">Termination</h2>
          <p className="p-paragraph">
          ...
          <h2 className="p-h2">Limitation of Liability</h2>
          <p className="p-paragraph">
          ...
          <h2 className="p-h2">Governing Law</h2>
          <p className="p-paragraph">
          ...
          <h2 className="p-h2">Disputes Resolution</h2>
          <p className="p-paragraph">
            If You have any concern or dispute about the Service, You agree to
            first try to resolve the dispute informally by contacting the
            Company.
          </p>
          <h2 className="p-h2">For European Union (EU) Users</h2>
          <p className="p-paragraph">
            If You are a European Union consumer, you will benefit from any
            mandatory provisions of the law of the country in which You are
            resident.
          </p>
          <h2 className="p-h2">United States Legal Compliance</h2>
          <p className="p-paragraph">
          ...
          <h2 className="p-h2">Severability and Waiver</h2>
          <h3 className="p-h3">Severability</h3>
          <p className="p-paragraph">
          ...
          <h2 className="p-h2">Translation Interpretation</h2>
          <p className="p-paragraph">
            These Terms and Conditions may have been translated if We have made
            them available to You on our Service. You agree that the original
            English text shall prevail in the case of a dispute.
          </p>
          <h2 className="p-h2">Changes to These Terms and Conditions</h2>
          <p className="p-paragraph">
