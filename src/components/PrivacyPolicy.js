...
const PrivacyPolicy = () => {
  return (
    <>
      <div className="py-[16px] text-primaryColor border-b border-[#eee]">
        <div className="container max-w-[1440px] px-5 mx-auto lg:px-10 xl:px-[63px]">
          <p className="m-0 text-[24px] leading-[24px] font-bold">
            Privacy Policy for SonicsTride
          </p>
        </div>
      </div>
      <div className="container max-w-[1440px] px-5 pt-2 mx-auto lg:px-10 xl:px-[63px]">
        <div className="block text-primaryColor">
          <h1 className="p-h1">Privacy Policy</h1>
          <p className="p-paragraph">Last updated: November 20, 2024</p>
          ...
          <h2 className="p-h2">Interpretation and Definitions</h2>
          <h3 className="p-h3">Interpretation</h3>
          <p className="p-paragraph">
          ...
          <h3 className="p-h3">Definitions</h3>
          <p className="p-paragraph">
          ...
          <ul className="p-ul">
            ...
            <li>
              <p className="p-paragraph">
                <strong>Website</strong> refers to SonicsTride, accessible from{" "}
                <a
                  href="https://www.sonicstride.com/"
                  rel="external nofollow noopener"
                  target="_blank"
                  className="underline text-[#0452a5] hover:no-underline"
                >
                  https://www.sonicstride.com/
                </a>
              </p>
            </li>
            <li>
          ...
          <h2 className="p-h2">Collecting and Using Your Personal Data</h2>
          <h3 className="p-h3">Types of Data Collected</h3>
          <h4 className="p-h4">Personal Data</h4>
          <p className="p-paragraph">
          ...
          <ul className="p-ul">
            <li>
              <p className="p-paragraph">Email address</p>
            </li>
            <li>
              <p className="p-paragraph">First name and last name</p>
            </li>
            <li>
              <p className="p-paragraph">Phone number</p>
            </li>
            <li>
              <p className="p-paragraph">Usage Data</p>
            </li>
          </ul>
          <h4 className="p-h4">Usage Data</h4>
          <p className="p-paragraph">
          ...
          <h4 className="p-h4">Tracking Technologies and Cookies</h4>
          <p className="p-paragraph">
          ...
          <ul className="p-ul">
            <li>
              ...
              <p className="p-paragraph">Type: Session Cookies</p>
              <p className="p-paragraph">Administered by: Us</p>
              <p className="p-paragraph">
            ...
            <li>
              ...
              <p className="p-paragraph">Type: Persistent Cookies</p>
              <p className="p-paragraph">Administered by: Us</p>
              <p className="p-paragraph">
          ...
          <h3 className="p-h3">Use of Your Personal Data</h3>
          <p className="p-paragraph">
          ...
          <h3 className="p-h3">Retention of Your Personal Data</h3>
          <p className="p-paragraph">
          ...
          <h3 className="p-h3">Transfer of Your Personal Data</h3>
          <p className="p-paragraph">
          ...
          <h3 className="p-h3">Delete Your Personal Data</h3>
          <p className="p-paragraph">
          ...
          <h3 className="p-h3">Disclosure of Your Personal Data</h3>
          <h4 className="p-h4">Business Transactions</h4>
          <p className="p-paragraph">
          ...
          <h4 className="p-h4">Law enforcement</h4>
          <p className="p-paragraph">
          ...
          <h4 className="p-h4">Other legal requirements</h4>
          <p className="p-paragraph">
            The Company may disclose Your Personal Data in the good faith belief
            that such action is necessary to:
          </p>
          <ul className="p-ul">
            <li className="p-paragraph">Comply with a legal obligation</li>
            <li className="p-paragraph">
            ...
            <li className="p-paragraph">Protect against legal liability</li>
          </ul>
          <h3 className="p-h3">Security of Your Personal Data</h3>
          <p className="p-paragraph">
          ...
          <h2 className="p-h2">Children&apos;s Privacy</h2>
          <p className="p-paragraph">
          ...
          <h2 className="p-h2">Links to Other Websites</h2>
          <p className="p-paragraph">
          ...
          <h2 className="p-h2">Changes to this Privacy Policy</h2>
          <p className="p-paragraph">
          ...
          <h2 className="p-h2">Contact Us</h2>
          <p className="p-paragraph">
          ...
          <ul className="p-ul">
            ...
            <li>
              <p className="p-paragraph">
                ...
                <a
                  href="https://www.sonicstride.com/contact"
                  rel="external nofollow noopener"
                  target="_blank"
                  className="underline text-[#0452a5] hover:no-underline"
                >
                  https://www.sonicstride.com/contact
                </a>
              </p>
            </li>
          </ul>
      ...
      <div className="py-[16px] text-primaryColor border-t border-[#eee] mt-[32px]">
        <div className="container max-w-[1440px] px-5 mx-auto lg:px-10 xl:px-[63px]">
          <p className="p-paragraph">
            Generated using{" "}
            <a
